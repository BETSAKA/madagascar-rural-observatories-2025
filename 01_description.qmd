...
Les Observatoires Ruraux (OR) de Madagascar sont un dispositif d'enquête longitudinale auprès de ménages ruraux, mis en place à partir de 1995 dans le cadre du réseau des observatoires ruraux coordonné par l'IRD et l'INSTAT, puis le Ministère de l'agriculture.
...
- la suppression du module dédié aux dépenses, qui était très long à administrer et qui avait peu été exploité dans le passé ;
- l'introduction de nouveaux modules sur les événements climatiques extrêmes, la sécurité alimentaire, les stratégies d'adaptation au changement climatique.
