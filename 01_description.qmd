...
Les principales modifications du questionnaire concernent : - la suppression du module dédié aux dépenses (D), qui était très long à administrer et qui avait peu été exploité dans le passé ; - l'introduction de nouveaux modules sur les feux (S), le rapport des ménages ruraux avec l'environnement (RM-UM-AP).
...
La structure spatiale de l'échantillon à l'Alaotra est plus fragmentée (8 sites contre 4 à Marovoay), reflétant la diversité des contextes autour de ces deux observatoires. 
- Alaotra : L'échantillon est réparti sur 8 hameaux. Les plus importants sont Avaradrano (17.8 %) et Feramanga Atsimo (17.6 %). 
...
res_deb |>
  ...
  tab_source_note(source_note = md("**Source : Enquête auprès des OR 2025**"))
```
La durée effective de collecte est quasiment identique entre les deux sites. 
- À l’Alaotra, l’enquête a duré 45 jours, du 1er octobre au 14 novembre 2025, pour 507 ménages. 
- À Marovoay, elle a duré 42 jours, s'achevant le 10 novembre 2025 pour 519 ménages.
...
La progression constante témoigne d'un rythme de travail homogène des équipes sur le terrain. Il n'y a pas eu d'interruption majeure ou de ralentissement logistique pendant la phase principale de collecte.
...
La majorité des enquêteurs a réalisé entre 45 et 55 questionnaires chacun. Cette répartition équilibrée de la charge de travail est un gage de qualité. Elle limite les risques de biais systématiques qu'un seul enquêteur pourrait introduire s'il traitait une part disproportionnée de l'échantillon. 
Selon Table 1.5, Le dispositif de contrôle est robuste avec un ratio moyen d'un superviseur pour environ 170 à 210 ménages. Ce taux d'encadrement élevé permet une vérification rigoureuse des questionnaires dès leur sortie du terrain. 
Les questionnaires ont été contrôlés par 6 superviseurs (S01 à S03 par site). 
- À l'Alaotra, les trois superviseurs ont une charge égale (166 à 172 questionnaires chacun). 
- À Marovoay, la supervision est plus concentrée sur S02 (217) et S03 (216), tandis que S01 n'en a supervisé que 86. 
...
res_deb |>
  ...
  tab_source_note(source_note = md("**Source : Enquête auprès des OR 2025**"))
```
 La répartition est extrêmement homogène, chaque opérateur ayant traité entre 252 et 260 questionnaires. Cette organisation standardisée garantit que le traitement informatique des 1 026 ménages a été effectué de manière fluide et rapide après la phase de collecte. 
Quatre opérateurs (OP01 à OP04) ont assuré la saisie informatique. (Table 1.6)
```{r}
