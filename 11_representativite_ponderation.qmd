...
# RGPH evaluation disabled — loading the 579 MB SPSS files is too slow
# for routine renders. Set to TRUE to re-enable RGPH comparison sections.
rgph_available <- FALSE
