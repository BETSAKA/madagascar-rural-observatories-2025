...
FR_TO_MG <- c(
  ...
  "**Source\u00a0: Enqu\u00eate aupr\u00e8s des OR 2025**" =
    "**Loharano\u00a0: Fanadihadiana OR 2025**",
  "Source\u00a0: Enqu\u00eate aupr\u00e8s des OR 2025" =
    "Loharano\u00a0: Fanadihadiana OR 2025",
  "Source : Enqu\u00eate aupr\u00e8s des OR 2025" =
    "Loharano : Fanadihadiana OR 2025",
  ...
  "Taille moyenne des m\u00e9nages par observatoire" =
    "Haben\u2019ny tokantrano isaky ny toeram-pikarohana",
  "Taille moyenne des m\u00e9nages" =
    "Haben\u2019ny tokantrano",
  "Taille moyenne des m\u00e9nages par hameau" =
    "Haben\u2019ny tokantrano isaky ny tan\u00e0na kely",
  "R\u00e9partition des membres du m\u00e9nage par tranche d'\u00e2ge" =
    "Fizarana ny mambra araka ny taona",
  "Origine des chefs de m\u00e9nage et conjoints" =
    "Fiavian\u2019ny lohan\u2019ny tokantrano sy ny vady",
  "Distribution de l'origine des CM et conjoints" =
    "Fizarana ny fiavian\u2019ny LT sy ny vady",
  "R\u00e9gion d'origine des CM et conjoints" =
    "Faritry ny fiavian\u2019ny LT sy ny vady",
  "Raison d'implantation des CM et conjoints" =
    "Antony nipetrahan\u2019ny LT sy ny vady",
  "Distribution des raisons d'implantation des CM et conjoints" =
    "Fizarana ny antony nipetrahan\u2019ny LT sy ny vady",
  "Caract\u00e9ristiques des chefs de m\u00e9nage" =
    "Toetoetry ny lohan\u2019ny tokantrano",
  "R\u00e9partition des chefs de m\u00e9nage selon leur niveau d'\u00e9ducation" =
    "Fizarana ny LT araka ny haavo-pahaizana",
  "R\u00e9partition des CM selon le niveau d'\u00e9ducation et le sexe" =
    "Fizarana ny LT araka ny haavo-pahaizana sy ny lahy/vavy",
  "Aptitude \u00e0 la lecture des chefs de m\u00e9nage" =
    "Fahaizan\u2019ny LT mamaky teny",
  "Aptitude \u00e0 la lecture des CM selon le sexe" =
    "Fahaizan\u2019ny LT mamaky teny araka ny lahy/vavy",
  "Aptitude \u00e0 l'\u00e9criture des chefs de m\u00e9nage" =
    "Fahaizan\u2019ny LT manoratra",
  "Aptitude \u00e0 l'\u00e9criture des CM selon le sexe" =
    "Fahaizan\u2019ny LT manoratra araka ny lahy/vavy",
  "Activit\u00e9s principales du chef de m\u00e9nage" =
    "Asa fototr\u2019ny lohan\u2019ny tokantrano",
  "Activit\u00e9s principales des CM (%)" =
    "Asa fototr\u2019ny LT (%)",
  "Activit\u00e9s principales des CM par sexe" =
    "Asa fototr\u2019ny LT araka ny lahy/vavy",
  "Activit\u00e9s principales des CM par observatoire et sexe (%)" =
    "Asa fototr\u2019ny LT isaky ny toeram-pikarohana sy lahy/vavy (%)",
  "Caract\u00e9ristiques des autres membres de m\u00e9nage" =
    "Toetoetry ny mambra hafa ao amin\u2019ny tokantrano",
  "Niveau d'\u00e9ducation des autres membres de m\u00e9nage" =
    "Haavo-pahaizana ny mambra hafa",
  "Niveau d'\u00e9ducation des autres membres par sexe" =
    "Haavo-pahaizana ny mambra hafa araka ny lahy/vavy",
  "Aptitude \u00e0 la lecture des autres membres" =
    "Fahaizan\u2019ny mambra hafa mamaky teny",
  "Aptitude \u00e0 la lecture des autres membres selon le sexe" =
    "Fahaizan\u2019ny mambra hafa mamaky teny araka ny lahy/vavy",
  "Aptitude \u00e0 l'\u00e9criture des autres membres" =
    "Fahaizan\u2019ny mambra hafa manoratra",
  "Aptitude \u00e0 l'\u00e9criture des autres membres selon le sexe" =
    "Fahaizan\u2019ny mambra hafa manoratra araka ny lahy/vavy",
  "Taux de scolarisation des enfants de 6 \u00e0 14 ans" =
    "Tahan\u2019ny fanabeazana ho an\u2019ny ankizy 6 ka hatramin\u2019ny 14 taona",
  "Classe suivie en 2024-2025 par cat\u00e9gorie d'\u00e2ge" =
    "Kilasy narahina tamin\u2019ny 2024-2025 araka ny sokajin-taona",
  "Principales raisons de non-scolarisation ou d'arr\u00eat des \u00e9tudes (6-15 ans)" =
    "Antony tsy fianarana na fijanonana (6-15 taona)",
  "Raisons de non-fr\u00e9quentation de l'\u00e9cole (6-15 ans)" =
    "Antony tsy fanarahana sekoly (6-15 taona)",
  "Activit\u00e9s principales des autres membres" =
    "Asa fototr\u2019ny mambra hafa",
  "Activit\u00e9s principales des autres membres (%)" =
    "Asa fototr\u2019ny mambra hafa (%)",
  "Activit\u00e9s principales des autres membres par sexe" =
    "Asa fototr\u2019ny mambra hafa araka ny lahy/vavy",
  "Activit\u00e9s des autres membres par observatoire et sexe (%)" =
    "Asa ny mambra hafa isaky ny toeram-pikarohana sy lahy/vavy (%)",
...
load_var_labels_mg <- function() {
  if (.var_labels_env$loaded) return(.var_labels_env$fr_to_mg)
