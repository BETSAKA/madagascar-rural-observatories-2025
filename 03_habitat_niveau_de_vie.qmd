...
::: {.content-hidden when-profile="marovoay"}
::: {.obs-alaotra}
**Alaotra.** `r pct_statut_a` % des ménages occupent un logement en « `r top_statut_a` ».
:::
:::

::: {.content-hidden when-profile="alaotra"}
::: {.obs-marovoay}
**Marovoay.** `r pct_statut_m` % des ménages occupent un logement en « `r top_statut_m` ».
:::
:::
...
::: {.content-hidden when-profile="marovoay"}
::: {.obs-alaotra}
**Alaotra.** Le type dominant est « `r top_lat_a` » (`r pct_lat_a` % des ménages).
:::
:::

::: {.content-hidden when-profile="alaotra"}
::: {.obs-marovoay}
**Marovoay.** Le type dominant est « `r top_lat_m` » (`r pct_lat_m` % des ménages).
:::
:::
...
::: {.content-hidden when-profile="marovoay"}
::: {.obs-alaotra}
**Alaotra.** La source principale est « `r top_eau_a` » (`r pct_eau_a` %).
:::
:::

::: {.content-hidden when-profile="alaotra"}
::: {.obs-marovoay}
**Marovoay.** La source principale est « `r top_eau_m` » (`r pct_eau_m` %).
:::
:::
