...
p_equip <- table_equip |>
  ...
  labs(title = obs_title("Équipements agricoles"), x = NULL, y = NULL) +
  theme_minimal(base_size = 13)
if (n_distinct(table_equip$Observatory) > 1) {
  p_equip <- p_equip + facet_wrap(~Observatory, ncol = 1, scales = "free_y")
}
p_equip
```
