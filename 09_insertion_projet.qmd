...
::: {.obs-alaotra}
**Alaotra.** `r pct_benef_a` % des ménages déclarent avoir bénéficié d'au moins un projet ou d'une formation.
:::
:::

::: {.content-hidden when-profile="alaotra"}
::: {.obs-marovoay}
**Marovoay.** `r pct_benef_m` % des ménages déclarent avoir bénéficié d'au moins un projet ou d'une formation.
:::
:::
...
::: {.content-hidden when-profile="marovoay"}
::: {.obs-alaotra}
**Alaotra.** `r pct_membre_a` % des ménages sont membres d'une organisation.
:::
:::

::: {.content-hidden when-profile="alaotra"}
::: {.obs-marovoay}
**Marovoay.** `r pct_membre_m` % des ménages sont membres d'une organisation.
:::
:::
