...
#| fig-cap: "Taux de vente de riz par observatoire"
...
#| fig-cap: "Perception des rendements des cultures non rizicoles"
...
#| fig-cap: "Évolution des rendements des cultures non rizicoles par rapport à l'an dernier"
...
#| fig-cap: "Part des ménages pratiquant l'exploitation forestière"
...
:::: {.content-hidden when-profile="marovoay"}
::: obs-alaotra
A Alaotra, parmi les ménages pratiquant l’exploitation forestière, les principaux produits sont très largement dominés par le **kitay**, cité par 99.6 % d’entre eux. Le **saribao** est également presque systématiquement exploité, avec une proportion de 98.9 %, tandis que le **hazo afok’ampy** concerne 94.6 % de ces ménages. En revanche, le **hazo ampiasaina** reste très peu mentionné, avec seulement 2.9 % des ménages concernés. Ces résultats montrent que l’exploitation forestière dans cet observatoire repose essentiellement sur quelques produits largement répandus parmi les ménages exploitants.
:::
::::

:::: {.content-hidden when-profile="alaotra"}
::: obs-marovoay
A Marovoay, parmi les ménages pratiquant l’exploitation forestière, le **kitay** constitue aussi le principal produit, utilisé par 99.5 % d’entre eux. Le **saribao** occupe une place tout aussi importante avec 98.9 %, alors que le **hazo afok’ampy** est mentionné par 89.9 % de ces ménages. Le **hazo ampiasaina** demeure marginal, avec une fréquence de seulement 6.4 %. L’exploitation forestière dans cet observatoire se caractérise ainsi par une forte concentration autour des produits énergétiques et du bois de chauffage.
:::
::::
...
#| fig-cap: "Principaux produits de l'exploitation forestière (% des ménages pratiquant l'exploitation forestière)"
